...
{
    /// <summary>
    /// Validates the <paramref name="input"/> using the specified <paramref name="func"/> and throws an <see cref="DomainValidationException"/> or a custom <see cref="Exception" /> if it evaluates to true.
    /// The <paramref name="func"/> should return true to indicate an invalid or undesirable state of the input.
    /// If <paramref name="func"/> returns true, an <see cref="DomainValidationException"/> or a custom <see cref="Exception" /> is thrown, signifying that the input is invalid.
    /// </summary>
    ...
    /// <exception cref="DomainValidationException">Thrown when the validation function returns true, indicating that the input is invalid.</exception>
    ...
    /// <summary>
    /// Validates the <paramref name="func"/> asynchronously and throws an <see cref="DomainValidationException" /> or a custom <see cref="Exception" /> if it evaluates to false for given <paramref name="input"/>
    /// The <paramref name="func"/> should return true to indicate an invalid or undesirable state.
    /// If <paramref name="func"/> returns true, indicating that the input is invalid, an <see cref="DomainValidationException"/> or a custom <see cref="Exception" /> is thrown.
    /// </summary>
    /// <typeparam name="T">The type of the input parameter.</typeparam>
    /// <param name="func">The function that evaluates the input. It should return true if the input is considered invalid or in a negative state.</param>
    /// <param name="guardClause">The guard clause instance.</param>
