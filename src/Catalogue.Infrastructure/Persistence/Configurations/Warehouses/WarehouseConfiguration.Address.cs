...
{
    public virtual void ConfigureAddress(EntityTypeBuilder<Warehouse> entityTypeBuilder)
    {
        entityTypeBuilder.ComplexProperty(warehouse => warehouse.Address, addressBuilder =>
        {
